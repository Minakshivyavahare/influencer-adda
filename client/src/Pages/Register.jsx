 ...
 const dispatch = useDispatch()
  ...
  const handleSubmit = (e) => {
    ...
    if(formData.password !== formData.confirmPassword){
      toast.error("passwords not matched", {position:"top-center"})
    }else{
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 shadow">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              className="group relative w-full flex justify-center bg-orange-500 text-white px-6 py-2 rounded-md cursor-pointer font-semibold"
            >
              Create Account
            </button>
          </div>
