...
const fetchAllUsersBookingForAdmin = async(token) => {
    const options  = {
       headers : {
...
const adminService = {fetchAllUsersBookingForAdmin,replyCommentByAdmin, updateBooking,deleteInfluencer,addInfluencer,updateInfluencer, fetchAllCommentsForAdmin,fetchInfluencersForAdmin,fetchAllUsersForAdmin}
